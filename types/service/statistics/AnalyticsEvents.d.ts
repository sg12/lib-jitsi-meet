...
export declare const ACTION_JVB_ICE_FAILED = AnalyticsEvents.ACTION_JVB_ICE_FAILED;
...
export declare const VIDEO_CODEC_CHANGED = AnalyticsEvents.VIDEO_CODEC_CHANGED;
/**
 ...
 */
export declare const createJvbIceFailedEvent: (action: unknown, attributes?: object) => {
    action: unknown;
    attributes: object;
    type: AnalyticsEvents;
};
