 ...
 */
export declare function getSourceNameForJitsiTrack(endpointId: EndpointId, mediaType: MediaType, trackIdx: number): SourceName;
/**
 ...
 * @returns {MediaType}
 */
export declare function getMediaTypeFromSourceName(sourceName: SourceName): MediaType;
/**
 ...
 * @returns {number}
 */
export declare function getSourceIndexFromSourceName(sourceName: SourceName): number;
/**
