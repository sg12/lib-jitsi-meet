...
export default class JitsiLocalTrack extends JitsiTrack {
    ...
    constructor({ constraints, deviceId, facingMode, mediaType, rtcId, sourceId, sourceType, stream, track, videoType, effects = [] }) {
        ...
        if (mediaType === MediaType.VIDEO) {
            ...
            if (!isValidNumber(this.resolution) && ((_a = this._constraints.height) === null || _a === void 0 ? void 0 : _a.ideal)) {
    ...
    _setMuted(muted) {
        ...
        if (this.isAudioTrack() || !doesVideoMuteByStreamRemove) {
            ...
            promise
                = RTCUtils.obtainAudioAndVideoPermissions(Object.assign(Object.assign({}, streamOptions), { constraints: { video: this._constraints } }));
