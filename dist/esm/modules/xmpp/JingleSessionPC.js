...
export default class JingleSessionPC extends JingleSession {
    ...
    _sendIceCandidates(candidates) {
        ...
        logger.debug(`${this} _sendIceCandidates count: ${candidates === null || candidates === void 0 ? void 0 : candidates.length}`);
    ...
    doInitialize(options) {
        ...
        pcOptions.usesCodecSelectionAPI = this.usesCodecSelectionAPI
            = browser.supportsCodecSelectionAPI()
                && ((_c = (_b = options.testing) === null || _b === void 0 ? void 0 : _b.enableCodecSelectionAPI) !== null && _c !== void 0 ? _c : true)
                && !this.isP2P;
        ...
        if (!this.isP2P) {
            ...
            pcOptions.capScreenshareBitrate = !(((_d = options.desktopSharingFrameRate) === null || _d === void 0 ? void 0 : _d.max) > SS_DEFAULT_FRAME_RATE);
        }
