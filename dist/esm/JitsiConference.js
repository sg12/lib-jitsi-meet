...
export default function JitsiConference(options) {
    ...
    const delay = Number.parseInt((_b = options.config.p2p) === null || _b === void 0 ? void 0 : _b.backToP2PDelay, 10);
    /**
    ...
    this._firefoxP2pEnabled = browser.isVersionGreaterThan(109)
        && ((_d = (_c = this.options.config.testing) === null || _c === void 0 ? void 0 : _c.enableFirefoxP2p) !== null && _d !== void 0 ? _d : true);
    /**
